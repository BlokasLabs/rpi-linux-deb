...
#define TSK_ACTIVE_MM 876 /* offsetof(struct task_struct, active_mm) */
#define TSK_STACK_CANARY 1008 /* offsetof(struct task_struct, stack_canary) */
...
#define MM_CONTEXT_ID 408 /* offsetof(struct mm_struct, context.id.counter) */
